 ...
 * author: esedyshev
 */
@OperationId("CustomerCards:BlockCardRegistered")
public class BlockCardRegisterResponse extends ProtocolMarkupObject<BlockCardRegisterResponse.Header> implements TransferConfirmationResponse
{
  private static final long serialVersionUID = 937590047943979184L;
