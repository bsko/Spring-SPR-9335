 ...
 * author: esedyshev
 */
@OperationId("CustomerGoals:VerifyCustomerGoalDeletion")
public class VerifyCustomerGoalDeletionResponse extends ProtocolMarkupObject<VerifyCustomerGoalDeletionResponse.Header>
{
